...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Aman Khan"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Aman Khan</td></tr>
					<tr><td>Profession</td><td>Data Analyst</td></tr>
					<tr><td>Sex</td><td>Male</td></tr>
					<tr><td>Portfolio</td><td><a href="" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:aman015018@gmail.com"><i class="fas fa-envelope"></i></a>
              
              <a href="https://www.linkedin.com/in/aman-khan007/"><i class="fab fa-linkedin"></i></a>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Aman Khan Facial Recognition">
    ...
    html: `
			<table>
				<tbody>
					...
					<tr><td>Working from home</td><td>Data Analyst</td><td>2024 - Still</td><td><a href="#" onclick="modal(event)" data-title="Working from home">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
  ...
  },
  {
    ...
    html: `<table>
			<tbody>
				<tr><td width="50%">Power BI</td><td>Python</td></tr>
				<tr><td width="50%">Excel</td><td>SQL</td></tr>
        <tr><td>Pandas</td><td>HTML</td></tr>
				<tr><td>JavaScript</td><td>Bootstrap</td></tr>
				<tr><td>Tailwind</td><td>Shopify</td></tr>
				<tr><td>CSS</td>
			</tbody>
		</table>`,
  },
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Aman" -lastName "Khan"',
        typing: true,
      },
      {
        text: "loading...",
...
var missions = {
  "Working from home": `
		...
		<h3>Directives</h3>
		<p>▪ During my academic career, I developed a solid foundation in data analysis techniques, statistical methodologies, and machine learning algorithms.</p>
    <p>▪ I have hands-on experience with various data analysis tools such as Python, R, SQL, and Excel, which I have used to clean, analyze, and visualize data.</p>
    <p>▪ I completed several projects and coursework that honed my ability to extract insights from complex datasets and present them in a clear and concise manner.</p>
	`,
};
